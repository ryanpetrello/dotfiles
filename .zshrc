...
function mutt() {
    pgrep -f 'watchmedo.*INBOX' || watchmedo shell-command --ignore-directories --recursive --command='~/.mutt/notify "${watch_src_path}"' $HOME/.mail/*/INBOX/new $HOME/.mail/*/pecan/new $HOME/.mail/*/openstack-dev/new &
